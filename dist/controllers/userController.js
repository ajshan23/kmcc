...
exports.exportAllUsers = exports.getPravasiWelfareMembership = exports.getSecuritySchemeDetails = exports.getNorkaDetails = exports.getAttendedEvents = exports.getProfile = exports.updateProfile = exports.uploadAvatar = exports.homePageData = exports.registerForEvent = exports.getEventById = exports.getEvents = void 0;
...
exports.getPravasiWelfareMembership = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId;
    if (!userId) {
        return res.status(401).json(new apiHandlerHelpers_1.ApiResponse(401, {}, "Unauthorized"));
    ...
    try {
        ...
        const pravasiWelfareAnswer = yield db_1.prismaClient.userSurveyAnswer.findFirst({
            where: {
                userId,
                question: {
                    text: {
        ...
        return res.status(200).json(new apiHandlerHelpers_1.ApiResponse(200, {
            isPravasiWelfareMember: pravasiWelfareAnswer === null || pravasiWelfareAnswer === void 0 ? void 0 : pravasiWelfareAnswer.answer,
        ...
        return res
            .status(500)
            .json(new apiHandlerHelpers_1.ApiResponse(500, {}, "Failed to fetch Pravasi Welfare membership status"));
    }
}));
const exceljs_1 = __importDefault(require("exceljs"));
exports.exportAllUsers = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        users.forEach((user) => {
            ...
            if (user.profile) {
                profileWorksheet.addRow({
                    ...
                    dateOfBirth: (_a = user.profile.dateOfBirth) === null || _a === void 0 ? void 0 : _a.toISOString().split('T')[0],
            ...
            user.EventRegistration.forEach((registration) => {
                ...
                eventsWorksheet.addRow({
                    ...
                    eventDate: (_a = registration.event.eventDate) === null || _a === void 0 ? void 0 : _a.toISOString().split('T')[0],
            ...
            user.LongTermInvestment.forEach((investment) => {
                ...
                investmentsWorksheet.addRow({
                    ...
                    lastDeposit: ((_a = investment.deposits[0]) === null || _a === void 0 ? void 0 : _a.depositDate.toISOString().split('T')[0]) || 'None',
        ...
        res.setHeader('Content-Disposition', `attachment; filename=kmcc_users_export_${new Date().toISOString().split('T')[0]}.xlsx`);
        ...
        return res.status(500).json(new apiHandlerHelpers_1.ApiResponse(500, {}, "Failed to export users data"));
    }
}));
